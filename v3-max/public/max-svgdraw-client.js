...
port.onmessage = function (event) {
  ...
  for( var key in obj )
  {
    ...
    const argv = (typeof objValue == 'object') ? objValue.length : 1;
...
*/
    ...
    break;
    case "draw/ellipse":
      if( argv == 4 ) // cx="200" cy="80" rx="100" ry="50"
      {
        if( typeof objectStack[id] != "undefined" )
          objectStack[id].remove();
    ...
    break;
    case "draw/rect":
      if( argv == 4 ) // x="50" y="20" width="150" height="150"
      {
        if( typeof objectStack[id] != "undefined" )
          objectStack[id].remove();
    ...
    break;
    case "draw/line":
      if( argv == 4 ) // x1="0" y1="0" x2="200" y2="200"
      {
        if( typeof objectStack[id] != "undefined" )
          objectStack[id].remove();
    ...
    break;
    case "draw/polygon":
      if( argv == 1 ) // points="220,10 300,210 170,250 123,234"
      {
        if( typeof objectStack[id] != "undefined" )
          objectStack[id].remove();
